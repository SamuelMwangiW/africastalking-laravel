...
class Stash
{
    ...
    public function send(string|Currency|null $currency = null, ?int $amount = null): StashTopupResponse
    {
        if (null !== $currency) {
    ...
    public function topup(string|Currency|null $currency = null, ?int $amount = null): StashTopupResponse
    {
